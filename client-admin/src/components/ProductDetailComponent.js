...
class ProductDetail extends Component {
  ...
  apiPostProduct(prod) {
    axios
      ...
      .then((res) =>
        res.data
          ? this.showToast("Thêm thành công!") && this.apiGetProducts()
          : alert("SORRY BABY!"),
      );
  }
  ...
  apiPutProduct(id, prod) {
    axios
      ...
      .then((res) =>
        res.data
          ? this.showToast("Chỉnh sửa thành công!") && this.apiGetProducts()
          : alert("SORRY BABY!"),
      );
  }
  ...
  apiDeleteProduct(id) {
    axios
      ...
      .then((res) =>
        res.data
          ? alert("OK BABY!") && this.apiGetProducts()
          : alert("SORRY BABY!"),
      );
  }
